...
class AssetComputeWorker {
    ...
    async preparePostProcess(rendition) {
        ...
        const postProcessingOptions = Object.assign({}, this.options);
        postProcessingOptions.source = {
            extension: this.source.extension
        };

        const intermediateInstructions = await prepareImagePostProcess(rendition, postProcessingOptions);
