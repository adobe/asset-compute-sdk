...
const { imageProcess } = require('./post-processing/image');
...
class AssetComputeWorker {
    ...
    async doPostProcess(rendition) {
        ...
        // const postProcessingEngine = this.postProcessingEngine || imageProcess;
        await imageProcess(rendition.path, postProcessedRendition.path, rendition.instructions);
