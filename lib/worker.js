...
class AssetComputeWorker {
    ...
    async prepare() {
        ...
        if (this.params.watermark.watermarkContent !== undefined && this.params.watermark.watermarkContent !== null) {
            this.watermark = await getWatermark(
                this.params.watermark.watermarkContent,
                this.directories.in,
                this.options.disableSourceDownload
            );
        }
