...
function process(params, options, workerFn) {
    ...
    return new Promise(function(resolve, reject) {
        try {
            ...
            var downloadTimer = timer_start();

            download.then(function(result) {
                result.timings.downloadInSeconds = timer_elapsed_seconds(downloadTimer);
                ...
                try {
                    var processingTimer = timer_start();
                    ...
                    return Promise.resolve(workerResult)
                        .then(function(workerResult) {
                            result.timings.processingInSeconds = timer_elapsed_seconds(processingTimer);
                ...
                result.uploadTimer = timer_start();
                ...
                result.timings.uploadInSeconds = timer_elapsed_seconds(result.uploadTimer);
                console.log("download of source file took", result.timings.downloadInSeconds, "seconds");
                console.log("processing of all renditions took", result.timings.processingInSeconds, "seconds");
                console.log("uploading of all renditions took", result.timings.uploadInSeconds, "seconds");
