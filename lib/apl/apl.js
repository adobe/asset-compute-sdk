                    ...
                    upload = Promise.all(params.renditions.map(function (rendition) {
                        ...
                        if (result.renditions[rendition.name]) {
                            return new Promise(function (resolve, reject) {
                                ...
                                console.log("start uploading", rendition.name, "to", rendition.url);
                                let body = "";
                                request({
                                    url: rendition.url,
                                    method: "PUT",
                                    ...
                                    body: fs.readFileSync(path.join(outdir, rendition.name))
                                    ...
                                    if (err) {
                                        ...
                                        console.log("done uploading", rendition.name);
                                        resolve(result);
                                    }
                                });
                            });
