...
async function process(params, options, workerFn) {
    console.warn(new Deprecation("[sdk][deprecation-warning] process() is deprecated, use worker() instead"));
...
async function forEachRendition(params, options, workerFn) {
    console.warn(new Deprecation("[sdk][deprecation-warning] forEachRendition() is deprecated, use batchWorker() instead"));
    if (typeof options === "function") {
        workerFn = options;
        options = {};
    }
