...
async function process(params, options, workerFn) {
    console.warn(new Deprecation("[sdk] process() is deprecated, use computeAllAtOnce() instead"));
...
async function forEachRendition(params, options, workerFn) {
    console.warn(new Deprecation("[sdk] process() is deprecated, use compute() instead"));
    if (typeof options === "function") {
        workerFn = options;
        options = {};
    }
