...
function parseBackgroundColor(instructions){
  const inputBackgroundColor = instructions.pdfbgcolor;
  ...
  if(Number.isInteger(inputBackgroundColor)
    ...
    && inputBackgroundColor <= 255){
      parsedColor = `rgb(${inputBackgroundColor},${inputBackgroundColor},${inputBackgroundColor})`;
  } else if(typeof inputBackgroundColor === 'string') {
    parsedColor = inputBackgroundColor;
  }
