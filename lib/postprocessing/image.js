...
async function render(img, instructions) {
    ...
    if (instructions.fmt === "jpg" && instructions.jpegSize) {
        ...
        if (stat.size > instructions.jpegSize) {
            ...
            try {
                ...
                console.log("imagemagick failed:", err);
                throw new GenericError(`Post processing of image rendition failed`, "image_post_process");
            }
        }
    }
}
