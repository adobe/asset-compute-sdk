...
async function getImageMetadata(file) {
    try {
        ...
        const metadataOfInterest = {};
        metadataOfInterest.format = metadata.FileType;
        metadataOfInterest.imageHeight = metadata.ImageHeight;
        metadataOfInterest.imageWidth = metadata.ImageWidth;
        metadataOfInterest.orientation = metadata.Orientation;
        metadataOfInterest.quality = metadata.JPEGQualityEstimate;
