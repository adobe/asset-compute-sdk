...
// async function createInDirectory() {
//     await fs.remove(IN_DIRECTORY);
//     await fs.mkdirs(IN_DIRECTORY);
//     console.log(`in directory: ${path.resolve(IN_DIRECTORY)}`);
//     return IN_DIRECTORY;
// }

// async function createOutDirectory() {
//     await fs.remove(OUT_DIRECTORY);
//     await fs.mkdirs(OUT_DIRECTORY);
//     console.log(`out directory: ${path.resolve(OUT_DIRECTORY)}`);
