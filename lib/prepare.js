...
async function createDirectories() {
    ...
    // for test-worker framework, input and output are mounted
    // input: read directly from mount
    // output: do not use /out mount as working directory, as it can have issues on Docker for Mac, but copy to /out at the end
