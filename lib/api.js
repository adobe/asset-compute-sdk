 ...
 */
function hasAtLeastOnePieplineRendtion(params){
...
function worker(renditionCallback, options = {}) {
    ...
    return actionWrapper(async function (params) {
        const usePipeline = hasAtLeastOnePieplineRendtion(params);
        if(usePipeline){
...
function shellScriptWorker(script = "worker.sh", options = {}) {
    ...
    return actionWrapper(function (params) {
      ...
      console.log(' ')
      console.log(' ')
      const usePipeline = true || hasAtLeastOnePieplineRendtion(params);
