...
function worker(renditionCallback, options = {}) {
    ...
    return actionWrapper(async function (params) {
        ...
        // TODO: Replace with `AssetComputePipeline` from `pipeline.js`
        
        // Move all of this pipeline logic into a class `AssetComputePipeline`
        // this class will work similarly to `AssetComputeWorker` and catch errors in the pipeline and send events/metrics
        // look at error type

        // TODO:
        // try/catch around engine to catch system errors
        // and throw a GenericError if it is not an error type we recognize
