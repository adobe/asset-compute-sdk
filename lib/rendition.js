...
const { FileMagic } = require('@npcz/magic/dist/file-magic');
...
class Rendition {
    ...
    async mimeType() {
        //  /Users/mathern/Desktop/git/@adobe/asset-compute-sdk/node_modules/@npcz/magic/dist/magic-js.wasm
        //  /Users/mathern/Desktop/git/@adobe/asset-compute-sdk/node_modules/@npcz/magic/dist/magic-js.wasm

        /*
        console.log('------------------------------');
        //console.log(path.join(__dirname, '..', 'node_modules', '@npcz/magic/dist/magic.mgc'));
        ...
        const mgcLocation = path.join(__dirname, '..', 'node_modules', '@npcz/magic/dist/magic.mgc');
        console.log('mgc file loc:', mgcLocation);
        FileMagic.magicFile = path.normalize(mgcLocation);

        //*
        const FileMagicInstance = await FileMagic.getInstance();

        // const version = FileMagicInstance.version();
