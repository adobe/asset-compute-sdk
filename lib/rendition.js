...
const Metadata = {
    ...
    TIFF_IMAGEHEIGHT: 'tiff:imageHeight', // should be tiff:imageLength
    TIFF_IMAGELENGTH: 'tiff:imageLength' 
};
...
class Rendition {
    ...
    async metadata() {
        ...
        try {
            ...
            // fix for wrong property usage
            meta[Metadata.TIFF_IMAGEHEIGHT] = dimensions.height;
            meta[Metadata.TIFF_IMAGELENGTH]= dimensions.height;
        } catch (err) {
            ...
            // remove any size metadata if there was an exception
            delete meta[Metadata.TIFF_IMAGEWIDTH];
            delete meta[Metadata.TIFF_IMAGEHEIGHT];
            delete meta[Metadata.TIFF_IMAGELENGTH];
        }
